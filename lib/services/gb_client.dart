...
class GbClient {
  ...
  Future<GbVideos> fetchVideos(int offset, int limit, int showId) async {
    ...
    var url = 'https://www.giantbomb.com/api/videos/?api_key=${this.apiKey}&sort=publish_date%3Adesc&field_list=saved_time,name,deck,hd_url,high_url,low_url,guid,publish_date,image,user,length_seconds,url,premium&format=JSON';
